...
export const config = {
  ...
  SERVICE_NAME: process.env.SERVICE_NAME || 'inventory-service',
  PORT: toNumber(process.env.PORT, 3002),
  RABBITMQ_URL: process.env.RABBITMQ_URL || 'amqp://localhost:5672',
  MONGO_URL: process.env.MONGO_URL || 'mongodb://localhost:27017/inventory',

  READY_TIMEOUT_MS: toNumber(process.env.READY_TIMEOUT_MS, 1500),
  READY_RMQ_CHECK_QUEUE: process.env.READY_RMQ_CHECK_QUEUE || 'order.created.q',
